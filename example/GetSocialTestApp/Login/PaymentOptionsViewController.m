...
else if ([segue.identifier isEqualToString:@"showuserinformation"])
{
    ShowUserDataViewController * showDataView = segue.destinationViewController;
    showDataView.name.text = self.first_name;
    showDataView.email.text = self.email;
}
